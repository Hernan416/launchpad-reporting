...
export function DashboardShell({
  ...
  return (
    <div className="min-h-screen bg-[#f4f6fa] dark:bg-[#16181d]">
      <header className="border-b border-border bg-white dark:bg-[#1e2128]">
        <div className="h-1.5 bg-gradient-to-r from-[#0067eb] to-[#ffcf00]" />
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          <h1 className="text-xl font-semibold tracking-tight text-[#0067eb] dark:text-[#4d9fff]">{title}</h1>
